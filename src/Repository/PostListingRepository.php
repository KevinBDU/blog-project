...
/**
 * @extends ServiceEntityRepository<PostListing>
 *
...
class PostListingRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(PostListing $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(PostListing $entity, bool $flush = true): void
    {
